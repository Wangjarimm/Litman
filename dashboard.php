...
<head>
    ...
    <style>
        ...
        .rek {
        margin-top: 125px; /* Atur margin-top sesuai kebutuhan */
    }
    </style>
</head>
...
<body>
    <div class="header">
        ...
        <h3 class="text-secondary float-left logo2">Flow</h3>
        <a href="logout">
            <div class="logout">
                        ...
                        <div class="rekening">
                            <div class="row tampil">
                                <div class="col-lg-6 rek">
                                    <canvas id="chartPemasukkan" width="400" height="200"></canvas>
                                </div>
                                <div class="col-lg-6 rek">
    ...
    <script>
        ...
        var dataPemasukkan = {
            ...
            datasets: [{
                ...
                borderColor: '#5db85b',
                data: [<?= $totalMasuk ?>] // Ganti dengan variabel totalMasuk yang sudah dihitung sebelumnya
            }]
        };
        ...
        var dataPengeluaran = {
            ...
            datasets: [{
                ...
                borderColor: '#d95350',
                data: [<?= $totalKeluar ?>] // Ganti dengan variabel totalKeluar yang sudah dihitung sebelumnya
            }]
        };

        // Inisialisasi grafik pemasukkan
        var ctxPemasukkan = document.getElementById('chartPemasukkan').getContext('2d');
        new Chart(ctxPemasukkan, {
            type: 'bar',
            data: dataPemasukkan,
            options: {
                responsive: true,
        ...
        // Inisialisasi grafik pengeluaran
